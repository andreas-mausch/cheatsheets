---
layout: cheatsheet
tags: security privacy gnupg openpgp nitrokey sequoia sq bip39key ssh pgpdump
...
section:
  ...
  - name: Inspect
    commands:
      ...
      Inspect via pgpdump: pgpdump test.txt.gpg
  - name: Export
    commands:
  ...
  - name: bip39key
    commands:
      Generate derived key and protect it with a passphrase: bip39key --user-id="TestUser <testuser@email.com>" --format=pgp --armor --authorization-for-sign-key --use-concatenation | sq key password --cert-file - --output - > key.secured.pgp
---
